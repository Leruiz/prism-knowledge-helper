  ...
  <div class="footer-container" :style="footerStyle">
    <div class="footer">
      <div class="footer-left">
        <el-button type="primary" round>Prism Knowledge Center</el-button>
      </div>
      <More direction="row" size="4" color="#666" placement="top" :opers="opers" />
    </div>
    <PostEditor :visible="postEditorVisible" :onClose="closePostEditor" />
  </div>
</template>
...
.footer-container {
  ...
  height: 50px;
  bottom: 0px;
  border-top: 1px solid rgb(233, 237, 242) !important;
  background: #fff;
